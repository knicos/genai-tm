...
export function AccuracyPerEpoch() {
    ...
    const hasValAccuracy = useMemo(() => history.some((h) => h.valAccuracy !== undefined), [history]);
    ...
    useEffect(() => {
        ...
        if (hasValAccuracy) {
            datasets.push({
                ...
                data: history.map((h) => h.valAccuracy ?? 0),
    ...
    }, [history, hasValAccuracy, maxEpoch, t]);
