...
describe("TrainingData component", () => {
    it('renders with no data', () => {
        render(<TrainingData active={true} data={[]} setData={() => {}} />);
    ...
    it('can add new classes', async () => {
        ...
        render(<TrainingData active={true} data={[]} setData={setData} />);
    ...
    it('renders with multiple data items but no samples', () => {
        ...
        render(<TrainingData active={true} data={testData} setData={() => {}} />);
